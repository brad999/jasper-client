...
class Mic:
    ...
    def __init__(self, speaker, passive_stt_engine, active_stt_engine, db, profile):
        ...
        passive_stt_engine -- performs STT while Nikita is in passive listen
                              mode
        acive_stt_engine -- performs STT while Nikita is in active listen mode
        """
    ...
    def activeListenToAllOptions(self, THRESHOLD=None, LISTEN=True,
        ...
        self.speaker.play(nikitapath.data('audio', 'beep_hi.wav'))
